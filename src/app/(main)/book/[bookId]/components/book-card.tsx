...
export function BookCard(props: IBookItemProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-[35.25rem] space-y-10 rounded-[10px] bg-gray-700 px-8 pb-4 pt-6">
      <div className="flex w-full flex-wrap items-stretch gap-8 max-sm:justify-center">
        ...
        <div className="flex min-w-40 flex-1 flex-col justify-between">
      ...
      <div className="flex w-full flex-wrap items-center gap-14 border-t border-gray-600 py-6">
